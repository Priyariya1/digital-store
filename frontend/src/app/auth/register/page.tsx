  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex w-1/2 bg-blue-500 flex-col justify-center items-center text-white p-12">
        <Image src="/re.png" alt="Illustration" width={380} height={380} className="mb-8" />
        <h2 className="text-3xl font-bold mb-4">Welcome to Digital Store!</h2>
        <p className="text-lg mb-2 text-center">Create an account to start exploring our digital products and exclusive features.</p>
        <div className="mt-8 text-center">
          <h3 className="text-xl font-semibold mb-2">Join Our Community</h3>
          <p className="text-base">Get access to high-quality digital products and special offers.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-white p-8">
        <div className="w-full max-w-md">
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-500">Please fill in your information to continue</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                autoComplete="name"
                required
                className="mt-1 block w-full px-3 py-2 border border-gray-300  text-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                value={name}
            ...
            <button
              ...
              // onClick={handleGoogleSignup} // Implement Google signup if needed
            >
